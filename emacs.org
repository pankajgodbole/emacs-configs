...
#+END_SRC
* Blogging
** Minimal setup using org-static-blog
#+begin_src emacs-lisp
  (setq org-static-blog-publish-title     "My Static Org Blog")
  (setq org-static-blog-publish-url       "https://pankajgodbole.github.io/")
  (setq org-static-blog-publish-directory "~/pankajgodbole.github.io/")
  (setq org-static-blog-posts-directory   "~/pankajgodbole.github.io/posts/")
  (setq org-static-blog-drafts-directory  "~/pankajgodbole.github.io/drafts/")
  ...
  "<div class=\"header\">
    <a href=\"https://pankajgodbole.github.io\">My Static Org Blog</a>
  </div>")
  ...
  <div>
   Icon(s) made by <a href="https://www.freepik.com" title="Freepik">Freepik</a>
...
#+BEGIN_SRC emacs-lisp
    ...
    (setq browse-url-browser-function
	  '(("." . eww-browse-url) ; Set EWW as the default web browser
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Evaluate expression
  (define-key key-translation-map (kbd "<f5>") (kbd "C-SPC e e"))
  ;; Duplicate expression in other window
  ...
  ;; Kill expression
  (define-key key-translation-map (kbd "<f8>") (kbd "C-SPC k e"))
  ;; Uncomment expression
  ;; (define-key key-translation-map (kbd "<f8>") (kbd "C-SPC C e"))

  ;; Undo
  (define-key key-translation-map (kbd "<f9>") (kbd "C-x u"))
  ;; Launch iBuffer
  ...
  ;; Copy line including trailing newline
  (define-key key-translation-map (kbd "C-<f3>") (kbd "C-SPC c l"))
  ;; Duplicate entire line including trailing newline
  (define-key key-translation-map (kbd "C-<f4>") (kbd "C-SPC d l"))
  ...
  ;; Copy
  (define-key key-translation-map (kbd "C-<f12>") (kbd "M-w"))

  ;; Launch ansi-term
  (define-key key-translation-map (kbd "M-<f1>") (kbd "C-SPC l t"))
  ;; Launch iBuffer
