...
#+begin_src emacs-lisp
    ...
    ;; Use Ctrl-Down and Ctrl-Up to move to the next and previous line respectively
    (add-hook 'cider-repl-mode-hook
	      (lambda ()
		(define-key key-translation-map (kbd "C-<down>") (kbd "C-n"))
		(define-key key-translation-map (kbd "C-<up>") (kbd "C-p"))))
